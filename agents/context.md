...
Self-hosted browser social game; product name undecided. [Design revision 4](../docs/SOCIAL_ROOM_DESIGN.md) is the supplied specification. Software starts at 0.1.0, independently of document revisions.
